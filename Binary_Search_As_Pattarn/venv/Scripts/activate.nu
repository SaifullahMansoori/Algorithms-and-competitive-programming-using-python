...
let virtual-env = "C:\Codes\Python\Binary_Search_As_Pattarn\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Codes\Python\Binary_Search_As_Pattarn\venv\Scripts\deactivate.nu"
